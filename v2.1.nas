...
#Pipes:version
// (no arguments)
	msg &fRunning Pipestone+ &a2.1&f, based on Pipes &a2.2
quit
...
// (no arguments)
	...
	if Pipes.threads|>=|16 msg &cError: actions exceeded 500k total (10 threads and {actionCount} actions), pipes cannot complete, aborting...
	if Pipes.threads|>=|16 jump #Pipes:cleanup
	newthread {runArg1}
terminate
